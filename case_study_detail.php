...
<main>
    ...
    <div class="case-study-detail-con grid-con">
        ...
        <div class="case-study-intro-box  col-span-full m-col-start-3 m-col-end-11">
            ...
            <p>This case study was based on this website's idea: 
                <a href="<?= htmlspecialchars($project['proj_reference_link']) ?>">
                    <?= htmlspecialchars($project['proj_reference_link']) ?>
                </a>
            </p>
        ...
        <div class="case-study-results  col-span-full m-col-start-3 m-col-end-11">
            <picture class="case-study-img-results">
                <?php if ($project['proj_image_link_1']): ?>
                
                    <img src="<?= htmlspecialchars($project['proj_image_link_1']) ?>" alt="image of final result">
                <?php endif; ?>
            </picture>
        ...
        <div class="case-study-problem  col-span-full m-col-start-3 m-col-end-11">
            <picture class="case-study-img-problem">
                <?php if ($project['proj_image_link_2']): ?>
                
                    <img src="<?= htmlspecialchars($project['proj_image_link_2']) ?>" alt="image of problem">
                <?php endif; ?>
            </picture>
        ...
        <div class="case-study-solution  col-span-full m-col-start-3 m-col-end-11">
            <picture class="case-study-img-solution">
                <?php if ($project['proj_image_link_3']): ?>
                
                    <img src="<?= htmlspecialchars($project['proj_image_link_3']) ?>" alt="image of solution">
                <?php endif; ?>
            </picture>

            <p><?= htmlspecialchars($project['proj_solution']) ?></p>
        </div>
